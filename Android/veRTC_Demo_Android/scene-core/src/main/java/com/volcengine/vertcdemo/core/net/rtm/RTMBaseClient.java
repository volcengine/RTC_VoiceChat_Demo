...
import static com.ss.bytertc.engine.handler.IRTCEngineEventHandler.UserMessageSendResult.USER_MESSAGE_SEND_RESULT_SUCCESS;
...
public abstract class RTMBaseClient {
    ...
    public void onLoginResult(String uid, int code, int elapsed) {
        ...
        if (code == IRTCEngineEventHandler.LoginErrorCode.LOGIN_ERROR_CODE_SUCCESS) {
