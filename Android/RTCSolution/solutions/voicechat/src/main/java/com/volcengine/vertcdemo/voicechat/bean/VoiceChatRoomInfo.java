 ...
 * 房间数据模型
 */
public class VoiceChatRoomInfo implements Parcelable {
    ...
    protected VoiceChatRoomInfo(Parcel in) {
    ...
    public static final Parcelable.Creator<VoiceChatRoomInfo> CREATOR = new Parcelable.Creator<VoiceChatRoomInfo>() {
        @Override
        public VoiceChatRoomInfo createFromParcel(Parcel source) {
            return new VoiceChatRoomInfo(source);
        }

        @Override
        public VoiceChatRoomInfo[] newArray(int size) {
            return new VoiceChatRoomInfo[size];
        }
    };
}
