...
@interface VoiceChatSeatCompoments () <VoiceChatSheetViewDelegate>
...
@implementation VoiceChatSeatCompoments
...
- (void)voiceChatSheetView:(VoiceChatSheetView *)voiceChatSheetView
    ...
    if (sheetState == VoiceChatSheetStatusInvite) {
        if ([self.delegate respondsToSelector:@selector
             (voiceChatSeatCompoments:clickButton:sheetStatus:)]) {
            [self.delegate voiceChatSeatCompoments:self
