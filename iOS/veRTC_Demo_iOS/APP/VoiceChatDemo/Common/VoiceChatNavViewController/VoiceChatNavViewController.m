...
#import "VoiceChatNavViewController.h"

@interface VoiceChatNavViewController ()<UIGestureRecognizerDelegate>

@property (nonatomic, strong) UILabel *navLabel;

@end

@implementation VoiceChatNavViewController
