...
@interface VoiceChatIMView ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) UITableView *roomTableView;

@end

@implementation VoiceChatIMView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    VoiceChatIMCell *cell = [tableView dequeueReusableCellWithIdentifier:@"VoiceChatIMCellID" forIndexPath:indexPath];
...
- (UITableView *)roomTableView {
    if (!_roomTableView) {
        ...
        [_roomTableView registerClass:VoiceChatIMCell.class forCellReuseIdentifier:@"VoiceChatIMCellID"];
